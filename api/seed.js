...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Insert 25 demo products
    const result = await col.insertMany(sampleProducts);
    return res.json({
      success: true,
      message: `Successfully populated ${result.insertedCount} products in MongoDB!`,
