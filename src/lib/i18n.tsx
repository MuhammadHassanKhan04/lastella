...
const dict = {
  en: {
    ...
    "common.currency": "SAR",
    "common.free_shipping": "Free shipping across Saudi Arabia on orders over SAR 200",
  ...
  ar: {
    ...
    "common.currency": "SAR",
    "common.free_shipping": "شحن مجاني داخل المملكة العربية السعودية للطلبات فوق ٢٠٠ ريال",
